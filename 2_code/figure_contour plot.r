...
# 1. Clear R workspace and load data
  ...
  #Scale temperature and difference in water potential values (mean centering)
...
## First method
	...
	filled.contour(x = fld$x,
				...
				z = fld$z,
				color.palette =
					colorRampPalette(c("purple", "orange")),
...
# Second method
	...
	image.plot(s, xlab = "Temperature", ylab = "Moisture Difference", las = 1, col = viridis(option = "magma", 50), legend.lab = " ", cex.main = 1.5, cex.axis = 1, axis.args = list(cex.axis = 1), cex.lab = 1.2)
